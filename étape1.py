...
#La fonction va nous permettre de générer le fichier qui se termine par _freq.txt car à l'inverse de la précédente elle trie les caracères selon leur fréquence puis selon lordre ASCII ça nous permettra donc de créer ce fichier de manière plus simple.
